...
// функция запоминает матрицы и определитель
...
//Эти функции проверяют есть такие матрицы
...
// вычисление определителя(матрица,размерность)
